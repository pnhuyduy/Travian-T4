...
##  Copyright:     TTWar (c) 2012-2013. All rights reserved.                   ##
##                                                                             ##
#################################################################################
?>
<style>.del {width:12px; height:12px; background-image: url(img/admin/icon/del.gif);}</style>
<?php
$id = $_GET['did'];
if(isset($id)){      
...
<table id="profile" cellpadding="1" cellspacing="1" border="1">
    <thead>
		<tr><th colspan="2"><div align="center"><ul class="tabs"><center><li>Village Information <a href="?p=village&did=<?php echo $_GET['did'];?>"><?php echo $village['name'];?></a></li></center></ul></div></th></tr>
	</thead>
	<tbody>
    <tr>
        <td>Village name:</td>
...
<?php if($_SESSION['access'] == ADMIN){ echo '<div align="right"><a href="index.php?p=edittroops&did='.$id.'">Edit troops</div></a>'; 
