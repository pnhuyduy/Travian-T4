...
$replace[54] = "<img src='img/x.gif' class='r1' title='".VL_LUMBER."' alt='".VL_LUMBER."'>";
$replace[55] = "<img src='img/x.gif' class='r2' title='".VL_CLAY."' alt='".VL_CLAY."'>";
$replace[56] = "<img src='img/x.gif' class='r3' title='".VL_IRON."' alt='".VL_IRON."'>";
$replace[57] = "<img src='img/x.gif' class='r4' title='".VL_CROP."' alt='".VL_CROP."'>";
