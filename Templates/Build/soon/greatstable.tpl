...
<div class="build_desc">
	<a href="#" onclick="return Travian.Game.iPopup(30,4);" class="build_logo">
		<img class="building big white g30" src="img/x.gif" alt="<?php echo B30;?>">
	</a>
...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#" onclick="return Travian.Game.iPopup(21,4, 'gid');"><?php echo B21;?></a> <span><?php echo BL_LVL;?> 20</span></span>
    </div>
	<div class="clear"></div>
</div>
