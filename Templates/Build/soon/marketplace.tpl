...
<div class="build_desc">
    ...
    <a href="#" onclick="return Travian.Game.iPopup(9,4, 'gid');"><?php echo B10;?></a> <span><?php echo BL_LVL;?> 1</span></span>, <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(10,4, 'gid');"><?php echo B11;?></a> <span><?php echo BL_LVL;?> 1</span></span>, <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(15,4, 'gid');"><?php echo B15;?></a> <span><?php echo BL_LVL;?> 3</span></span>
    </div>
	<div class="clear"></div>
</div>
