...
<div class="build_desc">
	<a href="#" onclick="return Travian.Game.iPopup(24,4);" class="build_logo">
		<img class="building big white g24" src="img/x.gif" alt="<?php echo B24;?>">
	</a>
...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#" onclick="return Travian.Game.iPopup(22,4, 'gid');"><?php echo B22;?></a> <span><?php echo BL_LVL;?> 10</span></span>, <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(15,4, 'gid');"><?php echo B15;?></a> <span><?php echo BL_LVL;?> 3</span></span>
    </div>
	<div class="clear"></div>
</div>
