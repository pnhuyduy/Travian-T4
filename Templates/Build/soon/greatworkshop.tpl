...
<div class="build_desc">
	<a href="#" onclick="return Travian.Game.iPopup(42,4);" class="build_logo">
		<img class="building big white g42" src="img/x.gif" alt="<?php echo B42;?>">
	</a>
...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#" onclick="return Travian.Game.iPopup(19,4, 'gid');"><?php echo B19;?></a> <span><?php echo BL_LVL;?> 20</span></span>
    </div>
	<div class="clear"></div>
</div>
