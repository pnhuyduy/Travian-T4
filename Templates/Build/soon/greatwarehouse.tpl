...
<div class="build_desc">
	<a href="#" onclick="return Travian.Game.iPopup(38,4);" class="build_logo">
		<img class="building big white g38" src="img/x.gif" alt="<?php echo B38;?>">
	</a>
...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(15,4, 'gid');"><?php echo B15;?></a> <span><?php echo BL_LVL;?> 10</span></span>
    </div>
	<div class="clear"></div>
</div>
