...
<div class="build_desc">
	<a href="#" onclick="return Travian.Game.iPopup(20,4);" class="build_logo">
		<img class="building big white g20" src="img/x.gif" alt="<?php echo B20;?>">
	</a>
...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#" onclick="return Travian.Game.iPopup(12,4, 'gid');"><?php echo B12;?></a> <span><?php echo BL_LVL;?> 3</span></span>, <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(22,4, 'gid');"><?php echo B22;?></a> <span><?php echo BL_LVL;?> 5</span></span>
    </div>
	<div class="clear"></div>
</div>
