...
<div class="build_desc">
	<a href="#" onclick="return Travian.Game.iPopup(25,4);" class="build_logo">
		<img class="building big white g25" src="img/x.gif" alt="<?php echo B25;?>">
	</a>
	<?php echo B25_DESC;?></div><div id="contract" class="contract contractNew contractWrapper">
    ...
    <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(15,4, 'gid');"><?php echo B15;?></a> <span><?php echo BL_LVL;?> 5</span></span>,<span class="buildingCondition"><a href="#" onClick="return Popup(26,4);"><strike><?php echo B26;?></strike></a></span>
    </div>
	<div class="clear"></div>
</div>
