...
<div class="build_desc">
	<a href="#" onclick="return Travian.Game.iPopup(28,4);" class="build_logo">
		<img class="building big white g28" src="img/x.gif" alt="<?php echo B28;?>">
	</a>
...
<div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#" onclick="return Travian.Game.iPopup(17,4, 'gid');"><?php echo B17;?></a> <span><?php echo BL_LVL;?> 20</span></span>, <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(20,4, 'gid');"><?php echo B20;?></a> <span><?php echo BL_LVL;?> 10</span></span>
    </div>
	<div class="clear"></div>
</div>
