...
<div class="build_desc">
	<a href="#" onclick="return Travian.Game.iPopup(14,4);" class="build_logo">
		<img class="building big white g14" src="img/x.gif" alt="<?php echo B14;?>">
	</a>
	<?php echo B14_DESC;?></div><div id="contract" class="contract contractNew contractWrapper">
    ...
    <a href="#" onclick="return Travian.Game.iPopup(16,4, 'gid');"><?php echo B16;?></a> <span><?php echo BL_LVL;?> 15</span></span>
    </div>
	<div class="clear"></div>
</div>
