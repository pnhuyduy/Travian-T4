...
<div class="build_desc">
	...
	<?php echo B27_DESC;?></div><div id="contract" class="contract contractNew contractWrapper">
    ...
    <span class="buildingCondition"><a href="#" onclick="return Travian.Game.iPopup(15,4, 'gid');"><?php echo B15;?></a> <span><?php echo BL_LVL;?> 10</span></span>,<span class="buildingCondition"><a href="#" onClick="return Travian.Game.iPopup(40,4, 'gid');"><strike><?php echo B40;?></strike></a></span>
    </div>
	<div class="clear"></div>
</div>
