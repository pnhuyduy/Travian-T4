        ...
        <div class="boxes-contents cf">
            ...
            <table cellpadding="1" cellspacing="1" id="npc" class="transparent">
                ...
                <tr>
                    ...
                    <td>
                        <img src="<?php echo GP_LOCATE; ?>img/r/1.gif" alt="Wood" title="<?php echo VL_WOOD;?>"> <input class="text"
                                                                                                       type="text"
                                                                                                       name="r1" id="r1"
                                                                                                       value=""
                                                                                                       maxlength="5"
                                                                                                       tabindex="1"
                                                                                                       style="width:50px;">
                        <img src="<?php echo GP_LOCATE; ?>img/r/2.gif" alt="Clay" title="<?php echo VL_CLAY;?>"> <input class="text"
                                                                                                       type="text"
                                                                                                       name="r2" id="r2"
                                                                                                       value=""
                                                                                                       maxlength="5"
                                                                                                       tabindex="1"
                                                                                                       style="width:50px;">
                        <img src="<?php echo GP_LOCATE; ?>img/r/3.gif" alt="Iron" title="<?php echo VL_IRON;?>"> <input class="text"
                                                                                                       type="text"
                                                                                                       name="r3" id="r3"
                                                                                                       value=""
                                                                                                       maxlength="5"
                                                                                                       tabindex="1"
                                                                                                       style="width:50px;">
                        <img src="<?php echo GP_LOCATE; ?>img/r/4.gif" alt="Wheat" title="<?php echo VL_CROP;?>"> <input class="text"
                                                                                                         type="text"
                                                                                                         name="r4"
                                                                                                         id="r4"
                                                                                                         value=""
