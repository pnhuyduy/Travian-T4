<h1 class="titleInHeader"><?php echo B6;?> <span class="level"> <?php echo BL_LVL.' '.$village->resarray['f'.$id]; ?></span></h1>
<div id="build" class="gid6">
<div class="build_desc">
<a href="#" onClick="return Travian.Game.iPopup(6,4);" class="build_logo">
	<img class="building big white g6" src="img/x.gif" alt="<?php echo B6;?>" title="<?php echo B6;?>" />
</a>
<?php echo B6_DESC; ?></div>
	...
	<table cellpadding="1" cellspacing="1" id="build_value">
		<tr>
			<th>
<?php echo CUR_INC_PROD; ?>:</th>
			<td><b><?php echo $bid6[$village->resarray['f'.$id]]['attri']?$bid6[$village->resarray['f'.$id]]['attri']:'0'; ?></b>%</td>
		</tr>
		<?php 
