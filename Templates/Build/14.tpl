<h1 class="titleInHeader"><?php echo B14;?> <span class="level"> <?php echo BL_LVL.' '.$village->resarray['f'.$id]; ?></span></h1>
<div id="build" class="gid14">
<div class="build_desc">
<a href="#" onClick="return Travian.Game.iPopup(14,4);" class="build_logo">
<img class="building big white g14" src="img/x.gif" alt="<?php echo B14;?>" title="<?php echo B14;?>" />
</a>
<?php echo B14_DESC; ?>
</div>
	...
	<table cellpadding="1" cellspacing="1" id="build_value">
		...
		if ($bindicate==10 || $bindicate==1) $ll -= 1;
			...
			<th><?php echo NEXT_SPEEDUP; echo $village->resarray['f'.$id]+$nc; ?>:</th>
