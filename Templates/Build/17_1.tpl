                        ...
                        <td>
                            <button type="button" value="r1Big" <?php if (isset($_GET['s']) && $_GET['s'] == 1) {
                                ...
                                echo "class=\"iconFilter\"";
                                    ...
                                    src="img/x.gif" class="r1Big" alt="r1Big"></button>
                        </td>
                        <td>
                            <button type="button" value="r2Big" <?php if (isset($_GET['s']) && $_GET['s'] == 2) {
                                ...
                                echo "class=\"iconFilter\"";
                                    ...
                                    onclick="window.location.href = 'build.php?id=<?php echo $id; ?>&t=1&s=2<?php if (isset($_GET['v'])) echo "&v=" . $_GET['v'];
                                        if (isset($_GET['b'])) echo "&b=" . $_GET['b']; ?>'; return false;"><img
                                    src="img/x.gif" class="r2Big" alt="r2Big"></button>
                        </td>
                        <td>
                            <button type="button" value="r3Big" <?php if (isset($_GET['s']) && $_GET['s'] == 3) {
                                ...
                                echo "class=\"iconFilter\"";
                                    ...
                                    onclick="window.location.href = 'build.php?id=<?php echo $id; ?>&t=1&s=3<?php if (isset($_GET['v'])) echo "&v=" . $_GET['v'];
                                        if (isset($_GET['b'])) echo "&b=" . $_GET['b']; ?>'; return false;"><img
                                    src="img/x.gif" class="r3Big" alt="r3Big"></button>
                        </td>
                        <td>
                            <button type="button" value="r4Big" <?php if (isset($_GET['s']) && $_GET['s'] == 4) {
                                ...
                                echo "class=\"iconFilter\"";
                                    ...
                                    onclick="window.location.href = 'build.php?id=<?php echo $id; ?>&t=1&s=4<?php if (isset($_GET['v'])) echo "&v=" . $_GET['v'];
                                        if (isset($_GET['b'])) echo "&b=" . $_GET['b']; ?>'; return false;"><img
                                    src="img/x.gif" class="r4Big" alt="r4Big"></button>
                        </td>
                    </tr>
                    </tbody>
                </table>
