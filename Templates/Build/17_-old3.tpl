<h1 class="titleInHeader"><?php echo B17;?> <span class="level"> <?php echo BL_LVL.' '.$village->resarray['f'.$id]; ?></span></h1>
...
<p><b><?php echo RAWMATERIALSDISTRIBUTED ?>.</b> <?php echo COST;?>: <b>3 </b><img src="img/x.gif" class="gold" alt="<?php echo GOLD;?>" title="<?php echo GOLD;?>" /></p>
...
<script language="JavaScript">var summe=<?php echo floor($village->awood+$village->acrop+$village->airon+$village->aclay); ?>;var max123=<?php echo $village->maxstore; ?>;var max4=<?php echo $village->maxcrop; ?>;</script> 
		...
		<table id="npc" cellpadding="1" cellspacing="1"> 
			...
			<td class="all"> 
				...
				<td class="sum"><?php echo TOTAL;?>:&nbsp;<span id="org4"><?php echo floor($village->awood+$village->acrop+$village->airon+$village->aclay); ?></span></td> 
			</tr> 
		</thead> 
		<tbody> 
			<tr> 
			...
			<td class="sum"><?php echo TOTAL;?>:&nbsp;<span id="newsum"><?php if(isset($_GET['r1']) && isset($_GET['r2']) && isset($_GET['r3']) && isset($_GET['r4'])) { echo $_GET['r1']+$_GET['r2']+$_GET['r3']+$_GET['r4']; } else { echo 0; } ?></span></td> 
		</tr> 
		<tr> 
		...
		<button type="submit" value="<?php echo TRADERESOURCES;?> (2/2)" id="npc_market_button" class="green build" onclick="$('npc_market_button').addClass('disabled').disabled = true;document.snd.submit();">
...
</div></div></button><span class="npc_price"><b>3</b><img src="img/x.gif" class="gold" /> <?php echo GOLD;?></span></p>
		<?php } else { echo"<a href=\"plus.php\"><span class=\"none\">".NOTENOUGHGOLD."</span></a>"; }?></p>
		<p id="submitText"></p> 
		</form> 
		<script> 
			calculateRest();
