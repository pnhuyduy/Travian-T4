        ...
        if ($technology->getTech($i)) {
            echo "<div class=\"action first\">
					...
					<div class=\"details\">
                        ...
                        <div class=\"showCosts\">
                        <span class=\"resources r1\"><img class=\"r1\" src=\"img/x.gif\" alt=\"" . VL_WOOD . "\">" . (${'u' . $i}['wood'] * 3) . "</span>
                        <span class=\"resources r2\"><img class=\"r2\" src=\"img/x.gif\" alt=\"" . VL_CLAY . "\">" . (${'u' . $i}['clay'] * 3) . "</span>
                        <span class=\"resources r3\"><img class=\"r3\" src=\"img/x.gif\" alt=\"" . VL_IRON . "\">" . (${'u' . $i}['iron'] * 3) . "</span>
                        <span class=\"resources r4\"><img class=\"r4\" src=\"img/x.gif\" alt=\"" . VL_CROP . "\">" . (${'u' . $i}['crop'] * 3) . "</span>
