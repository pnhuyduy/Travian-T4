<h1 class="titleInHeader"><?php echo B15;?> <span class="level"> <?php echo BL_LVL.' '.$village->resarray['f'.$id]; ?></span></h1>
<div id="build" class="gid15">
<div class="build_desc">
<a href="#" onClick="return Travian.Game.iPopup(15,4);" class="build_logo">
<img class="building big white g15" src="img/x.gif" alt="<?php echo B15;?>" title="<?php echo B15;?>" />
	...
	<table cellpadding="1" cellspacing="1" id="build_value">
        ...
        if(!$building->isMax($village->resarray['f'.$id.'t'],$id)) {
			...
			for($nc=1;$nc<=$ll;$nc++){?>
				...
				<td><b><?php echo round($bid15[$village->resarray['f'.$id]+$nc]['attri']); ?></b> <?php echo PERCENT;?></td>
				</tr>
            <?php
            }
		}
