...
<img id="big_unit" class="u11Section" src="img/x.gif" alt="Clubswinger" title="Clubswinger" /><div id="t_desc">Clubswingers are the cheapest unit in TTWar. They are quickly trained and have medium attack capabilities but their armour isn’t the best. Clubswingers are almost defenceless against cavalry and will be ridden down with ease.</div><div id="prereqs"><b>Prerequisites</b><br /><a href="manual.php?typ=4&amp;gid=19">Barracks</a> Level 1</div><map id="nav" name="nav">
