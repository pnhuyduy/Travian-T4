...
<img id="big_unit" class="u28Section" src="img/x.gif" alt="Trebuchet" title="Trebuchet" /><div id="t_desc">The Trebuchet is an excellent long-distance weapon; it is used to destroy the fields and buildings of enemy villages. However, without escorting troops it is almost defenceless so don't forget to send some of your troops with it.
<br /><br />
