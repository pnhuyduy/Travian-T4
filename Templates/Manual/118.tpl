...
<img id="big_unit" class="u18Section" src="img/x.gif" alt="Catapult" title="Catapult" /><div id="t_desc">The Catapult is an excellent long-distance weapon; it is used to destroy the fields and buildings of enemy villages. However, without escorting troops it is almost defenceless so don't forget to send some of your troops with it. 
<br /><br />
