...
<img id="big_unit" class="u13Section" src="img/x.gif" alt="Axeman" title="Axeman" /><div id="t_desc">This is the Teuton's strongest infantry unit. He is strong at both offence and defence but he is slower and more expensive than other units.</div><div id="prereqs"><b>Prerequisites</b><br /><a href="manual.php?typ=4&amp;gid=22">Academy</a> Level 3, <a href="manual.php?typ=4&amp;gid=12">Blacksmith</a> Level 1</div><map id="nav" name="nav">
