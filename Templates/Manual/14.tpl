...
<img id="big_unit" class="u4Section" src="img/x.gif" alt="Equites Legati" title="Equites Legati" /><div id="t_desc">The Equites Legati are the roman reconnaissance troops. They are pretty fast and can spy on enemy villages in order to see resources and troops.
<br /><br />
