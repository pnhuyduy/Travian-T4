...
<img id="big_unit" class="u25Section" src="img/x.gif" alt="Druidrider" title="Druidrider" /><div id="t_desc">This medium cavalry unit is brilliant at defence. The main purpose of the Druidrider is to defend against enemy infantry. Its costs and supply are relatively expensive.</div><div id="prereqs"><b>Prerequisites</b><br /><a href="manual.php?typ=4&amp;gid=22">Academy</a> Level 5, <a href="manual.php?typ=4&amp;gid=20">Stable</a> Level 5</div><map id="nav" name="nav">
