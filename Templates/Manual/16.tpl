...
<img id="big_unit" class="u6Section" src="img/x.gif" alt="Equites Caesaris" title="Equites Caesaris" /><div id="t_desc">The Equites Caesaris are the heavy cavalry of Rome. They are very well armoured and deal great amounts of damage, but all that armour and weaponry comes with a price. They are slow, carry less resources and feeding them is expensive.</div><div id="prereqs"><b>Prerequisites</b><br /><a href="manual.php?typ=4&amp;gid=20">Stable</a> Level 10, <a href="manual.php?typ=4&amp;gid=22">Academy</a> Level 5</div><map id="nav" name="nav">
