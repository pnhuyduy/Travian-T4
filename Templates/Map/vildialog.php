...
<?php if(!$basearray['occupied'] && $basearray['oasistype'] && !$basearray['fieldtype']){
	...
	<?php if(isset($basearray['occupied']) && $basearray['occupied'] && isset($basearray['capital']) && $basearray['capital']) { echo "<span class=\"mainVillage\">(پایتخت)</span>"; } ?>
...
<div class="detailImage">
	<div class="options">
	 ...
	 <?php 
		...
		<?php } 
			else if ($basearray['occupied']==1 && $basearray['oasistype']==0 && $basearray['wref'] != $village->wid) {
		?>
		<div class="option">
          <?php 
