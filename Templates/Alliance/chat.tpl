...
function show_data_cb(text) { document.getElementById("chat").innerHTML = text; }
function start_it() { x_get_data(show_data_cb); setTimeout("start_it()",2000); }
function add_cb() {}
function send_data() {
...
<form name="form1" onSubmit="send_data()" action="allianz.php?s=6" method="POST" id="Form1">
	<div id="TitleName" class="chatHeader"><div style="float:left;"></div><div style="float:right;" id="TitleClose"></div><div style="text-align:middle">Ally-Chat</div></div>
		...
		<span dir="ltr"><div id="chat" style="position:absolute; top:10; right:5px; width:530px; background-color: #FFF;text-align:left; "><center><img src="img/loadingshetab.gif" style="position: absolute;top: 100px;left:245px;"></div>
		...
		<div id="scrollbarbackground" style="position: absolute; top: 0; left: 539px; width: 1px; height: 238px; border-width: 1px; border-style: solid; border-color: #71D000; background-color: #FFF;"></div>
			...
			<div style="margin-top:10px; margin-bottom:10px;">
				<table cellpadding="1" cellspacing="1" id="chat_input"><tr><td>
				<input name="s" value="6" type="hidden" />
        <input class="text" type="text" name="msg" id="message" style="display: block; " />
        <input type="button" src="x.gif" id="btn_ok" style="border: 0px; float:left; height:0px; width:0px;" alt="ok" onClick="send_data()" /></td>
		
				</td><td>
				<input type="hidden" id="room" name="room" value="429280664">
				<input type="hidden" id="joincmd" name="joincmd" value="ss"></div>
				</td></tr></table>
			</div>
</form>
</body> 
			<div id="rooms"><span id="room429280664" name="-2" class="roomselectorActive"><span style="float:left;"><a href="" onclick="submitform2()"><span id="channelName429280664">Ally-Chat</span></a></span><span id="userCount429280664" style="float:left;"></span></span></div>
