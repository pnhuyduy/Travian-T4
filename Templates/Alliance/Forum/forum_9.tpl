...
//////////////// made by TTMTT ////////////////
    if ($session->access != BANNED) {
        ...
        <form method="post" name="post"
              action="allianz.php?s=2&pid=<?php echo $_GET['pid']; ?>&tid=<?php echo $_GET['idt']; ?>">
            ...
            <table class="transparent" id="new_post">
                <?php
                    ...
                    if (mysql_query($q)) {
                        ...
                        if ($q && $q['voters'] == 0) {
                            ?>
                            <?php echo AL_SURVEY;?> - <input class="text" type="text" name="option_5" maxlength="60"
                                            value="<?php echo $q['name']; ?>"/>
                            <tr>
                                <td colspan="2" class="poll">
                                    <table cellpadding="0" cellspacing="0" id="poll">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td class="sel">1- <input class="text" type="text" name="option_1"
                                                                      maxlength="60"
                                                                      value="<?php echo $q['p1_name']; ?>"/></td>

                                            <td class="sel">2- <input class="text" type="text" name="option_2"
                                                                      maxlength="60"
                                                                      value="<?php echo $q['p2_name']; ?>"/></td>
                                        </tr>
                                        <tr>
                                            <td class="sel">3- <input class="text" type="text" name="option_3"
                                                                      maxlength="60"
                                                                      value="<?php echo $q['p3_name']; ?>"/></td>

                                            <td class="sel">4- <input class="text" type="text" name="option_4"
                                                                      maxlength="60"
                                                                      value="<?php echo $q['p4_name']; ?>"/></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                        ...
                        ?>
                        <h4 class="round"><font color=red><?php echo AL_CHANGEINFONOCOM;?></font></h4>
                    <?php } ?>
                <tbody>
                <tr>
