...
<table id="warehouse" cellpadding="1" cellspacing="1">
    ...
    <tr>
        ...
        <td><img class="r1" src="img/x.gif" title="<?php echo VL_WOOD; ?>" alt="<?php echo VL_WOOD; ?>"></td>
        <td><img class="r2" src="img/x.gif" title="<?php echo VL_CLAY; ?>" alt="<?php echo VL_CLAY; ?>"></td>
        <td><img class="r3" src="img/x.gif" title="<?php echo VL_IRON; ?>" alt="<?php echo VL_IRON; ?>"></td>
        <td><img class="clock" src="img/x.gif" title="<?php echo AT_DURATION; ?>" alt="<?php echo AT_DURATION; ?>"></td>
        <td><img class="r4" src="img/x.gif" title="<?php echo VL_CROP; ?>" alt="<?php echo VL_CROP; ?>"></td>
        <td><img class="clock" src="img/x.gif" title="<?php echo AT_DURATION; ?>" alt="<?php echo AT_DURATION; ?>"></td>
    </tr>
    </thead>
    <tbody>
