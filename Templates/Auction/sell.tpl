    ...
    <div id="filter">
        <div class="boxes boxesColor gray">
            ...
            <div class="boxes-contents cf">
                <div class="wrapper">
                    <div class="silver">
                        <img title="<?php echo HDR_SILVER; ?>" class="silver"
    ...
    if ($query == 0) {
        ...
        while ($row = mysql_fetch_array($sql)) {
            ...
            if (($usedtime > (AUCTIONTIME / 10)) || ($bids != 0)) {
                $outputList .= "<tr><td class=\"delete\"><img class=\"del inactive\" src=\"img/x.gif\" title=\"" . HR_CANCEL . "\"></td><td class=\"icon\"><img class=\"itemCategory itemCategory_" . $typeArray[$btype] . "\" src=\"img/x.gif\" title=\"" . $title . "\"></td>";
            } else {
                $outputList .= "<tr><td class=\"delete\"><a href=\"?action=sell&abort=" . $id . "\"><img class=\"del\" src=\"img/x.gif\" title=\"" . HE_CANCEL . "\"></a></td><td class=\"icon\"><img class=\"itemCategory itemCategory_" . $typeArray[$btype] . "\" src=\"img/x.gif\" title=\"" . $title . "\"></td>";
            }
...
<?php
    ...
    if ($page == "1" && $lastPage == "1") {
        $paginationDisplay .= '<img alt="' . NEXTPAGE . '" src="img/x.gif" class="first disabled"> ';
        ...
        $paginationDisplay .= '<img alt="' . PREVPAGE . '" src="img/x.gif" class="previous disabled">';
        $paginationDisplay .= $centerPages;
        $paginationDisplay .= '<a class="next" href="?action=sell&page=' . $nextPage . '"><img alt="' . NEXTPAGE . '" src="img/x.gif"></a> ';
        $paginationDisplay .= '<a class="last" href="?action=sell&page=' . $lastPage . '"><img alt="' . LASTPAGE . '" src="img/x.gif"></a>';

    } elseif ($page != "1" && $page != $lastPage) {
        $paginationDisplay .= '<a class="first" href="?action=sell&page=1"><img alt="' . FIRSTPAGE . '" src="img/x.gif"></a> ';
        $paginationDisplay .= '<a class="previous" href="?action=sell&page=' . $previous . '"><img alt="' . PREVPAGE . '" src="img/x.gif"></a>';
        $paginationDisplay .= $centerPages;
        $paginationDisplay .= '<a class="next" href="?action=sell&page=' . $nextPage . '"><img alt="' . NEXTPAGE . '" src="img/x.gif"></a> ';
        $paginationDisplay .= '<a class="last" href="?action=sell&page=' . $lastPage . '"><img alt="' . LASTPAGE . '" src="img/x.gif"></a>';
    ...
    Travian.Game.HeroAuction = new (new Class(
        {
            ...
            textMulti: '<?php echo HR_SELL;?> &lt;input class=\"text\" id=\"sellAmount\" style=\"width:30px\" type=\"text\" value=\"0\" /&gt; <?php echo UNIT;?>'.unescapeHtml(),
            initialize: function () {
                var $this = this;
                <?php
                $prefix = "".TB_PREFIX."heroitems";
            ...
            noMoreAuctions: function () {
                ...
                echo sprintf(HR_MAXSELLDESC,MAXSELL);?>').dialog(
                    {
                        relativeTo: $('content'),
