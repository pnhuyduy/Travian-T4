    ...
    <div class="boxes boxesColor gray">
        ...
        <div class="boxes-contents">
            <div class="wrapper">
                ...
                <div class="silver"><img title="<?php echo HDR_SILVER; ?>" class="silver" src="img/x.gif">
                ...
                <div class="filterContainer">
                    ...
                    <button title="<?php echo HR_FILTER2; ?>" type="button"
                        ...
                        echo "class=\"iconFilter\"";
                            ...
                            src="img/x.gif" class="itemCategory itemCategory_body" alt="itemCategory itemCategory_body">
                    </button>
                    ...
                    <button title="<?php echo HR_FILTER9; ?>" type="button"
                        ...
                        echo "class=\"iconFilter\"";
                            ...
                            src="img/x.gif" class="itemCategory itemCategory_cage" alt="itemCategory itemCategory_cage">
                    </button>
    ...
    if ($query == 0) {
        ...
        while ($row = mysql_fetch_array($sql)) {
            ...
            if (isset($_GET['a']) && $_GET['a'] == $id) {
                ...
                $outputList .= "<span> (" . HR_MINBID . " <img title=\"" . HDR_SILVER . "\" class=\"silver\" src=\"img/x.gif\"> " . $silver . ")</span>";
...
<table class="currentBid" cellspacing="1" cellpadding="1">
    ...
    <tr>
        ...
        <th class="bids"><img alt="<?php echo HR_BID; ?>" class="bids" src="img/x.gif"></th>
        <th class="silver"><img alt="<?php echo HDR_SILVER; ?>" class="silver" src="img/x.gif"></th>
        <th class="time"><img alt="<?php echo HR_DURATION; ?>" class="clock" src="img/x.gif"></th>
