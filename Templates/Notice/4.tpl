    ...
    if ($showThemAll && $showAllTroops) {
        ...
        <tr>
            ...
            <td colspan="11">
                <div class="res">
                    <div class="rArea">
                        <img class="r1" src="img/x.gif" title="<?php echo VL_LUMBER; ?>"><?php echo $dataarray[25]; ?>
                    </div>
                    <div class="rArea">
                        <img class="r2" src="img/x.gif" title="<?php echo VL_CLAY; ?>"><?php echo $dataarray[26]; ?></div>
                    <div class="rArea">
                        <img class="r3" src="img/x.gif" title="<?php echo VL_IRON; ?>"><?php echo $dataarray[27]; ?></div>
                    <div class="rArea">
                        <img class="r4" src="img/x.gif" title="<?php echo VL_CROP; ?>"><?php echo $dataarray[28]; ?></div>
                </div>
                <div class="clear"></div>
                <div class="carry">
                    <?php
